...
sourceChangeAddress: string, destinationChain: ExportChainsP): Promise<import("@c4tplatform/caminojs/dist/apis/platformvm").UnsignedTx>;
/**
 *
 * @param fromAddresses
 * @param toAddress
...
fromAddressBech: string, destinationChain: ExportChainsC, fee: BN): Promise<import("@c4tplatform/caminojs/dist/apis/evm").UnsignedTx>;
